...
public abstract class AbstractUVCCameraHandler extends Handler {
	...
	private AbstractUVCCameraHandler.UVCFrameCallBack mUVCFrameCallBack;
	...
	public void setFrameCallBack(AbstractUVCCameraHandler.UVCFrameCallBack mUVCFrameCallBack) {
		this.mUVCFrameCallBack = mUVCFrameCallBack;
	}
	...
	static final class CameraThread extends Thread {
		...
		private final IFrameCallback mIFrameCallback = new IFrameCallback() {
			...
			public void onFrame(final ByteBuffer frame) {
			    if (getHandler().mUVCFrameCallBack != null){
                    getHandler().mUVCFrameCallBack.onFrame(frame);
                }
//                if (AbstractUVCCameraHandler.mUVCFrameCallBack != null) {
//                    AbstractUVCCameraHandler.mUVCFrameCallBack.onFrame(frame);
//                }
