...
//            }
            ...
            UsbDevice device = deviceList.get(i % deviceList.size());
            String msg = "Device -- " +
                    "getDeviceName = " + device.getProductName() + "" +
                    "getDeviceId = "+device.getDeviceId()+ "" +
                    "getProductId = "+device.getProductId();
    ...
    private final OnDeviceConnectListener mOnDeviceConnectListener = new OnDeviceConnectListener() {
        ...
        public void onAttach(final UsbDevice device) {
            ...
            final List<DeviceFilter> filters = DeviceFilter.getDeviceFilters(MainActivity.this, com.serenegiant.uvccamera.R.xml.device_filter);
